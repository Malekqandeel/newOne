...
import { createNewTicket,deleteTicket, setTickets,updateTicketById } from "../lib/features/ticket";
    ...
    <span class="font-medium">Dark alert!</span> Change a few things up and try submitting again.
          ...
          {ticket.map((item)=>(
            ...
            <div class="flex flex-col items-center p-10">
                <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src={item.cover} alt="Bonnie image"/>
                ...
                <div class="flex mt-4 md:mt-6">
                    ...
                    <a href="#" class="py-2 px-4 ms-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700" onClick={deleteTicketFun(item.id)}>DELETE</a>
                </div>
            </div>
        </div>
          ))}
      ...
      <div
        id="UPDATE"
        className={`fixed top-0 left-0 z-40 w-96 h-screen p-4 overflow-y-auto transition-transform ${show ? 'translate-x-0' : '-translate-x-full'} bg-white dark:bg-gray-800`}
      >
